...
const DEFAULT_HERO = {
  ...
  description:
    "QuickLanding's intelligent builder creates conversion-optimized pages with zero coding. Perfect for startups, agencies, and growth teams who need results fast.",
  features: [
